...
public class LessonChapterDao {
	 ...
	 * 可以免费观看的视频
	 */
	public List<LessonChapterSectionPojo> getSectionList(String email, String lesson_id) {
		...
		List<LessonChapterSectionPojo> list = jdbcTemplate.query(sql, new Object[] { lesson_id, email },
				new BeanPropertyRowMapper(LessonChapterSectionPojo.class));
		return list;
	}
	...
	public List<LessonChapterSectionPojo> getOneSection(String LessonId, String chapterNo, String sectionNo) {
		...
		List<LessonChapterSectionPojo> list = jdbcTemplate.query(sql, new Object[] { LessonId, chapterNo, sectionNo },
				new BeanPropertyRowMapper(LessonChapterSectionPojo.class));
		return list;
	}
