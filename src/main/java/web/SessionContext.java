...
public class SessionContext {
	...
	// 获取当前登录用户
	public static UserDetails getAuthUser(HttpServletRequest request) {

		UserDetails userDetails =  (UserDetails)SessionContext.getAttribute(request, request.getRequestedSessionId());
